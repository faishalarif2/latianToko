...
import pws.a.contoh.a.exceptions.NonexistentEntityException;
import pws.a.contoh.a.exceptions.PreexistingEntityException;
...
public class BarangJpaController implements Serializable {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("pws.a_contoh.a_jar_0.0.1-SNAPSHOTPU");
